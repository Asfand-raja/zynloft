...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="privacy-body-wrap min-h-screen font-body-md bg-background text-on-background selection:bg-primary-container selection:text-on-primary-container">
      {/* Main Content */}
            ...
            <section id="rights">
              ...
              <div className="font-body-md text-body-md text-on-surface-variant leading-relaxed space-y-4">
                ...
                <div className="bg-surface-container-low border-l-4 border-primary p-6 mt-8">
                  <p class="italic text-on-surface">"Zynloft Solutions does not sell, trade, or otherwise transfer your personally identifiable information to outside parties."</p>
                </div>
              </div>
            </section>
          </article>
